...
/***/ function(module, exports) {
	...
	module.exports = "<!-- <div id=\"test\" type=\"tpl\">  <h1>{{title}}</h1>  <ul>      {{each list as value i}}          <li>索引 {{i + 1}} ：{{value}}</li>      {{/each}}  </ul></div> --><div class=\"container\">    <header>        <ul>            <li class=\"iconfont\">&#xe610;</li>            <li>                <span>彭展</span>                <span class=\"active\">刘东</span>            </li>            <li class=\"iconfont\">&#xe689;</li>        </ul>    </header>    <nav>        <ul id=\"swiper-nav\">            <li class=\"active\">足球小姐</li>            <li>足球小姐</li>            <li>足球小姐</li>        </ul>    </nav>    <section>      <div class=\"swiper-container\" id=\"index-swiper\">        <div class=\"swiper-wrapper\">          <div class=\"swiper-slide\">             <section id=\"index-scroll\">                <script id=\"list\" type=\"text/html\">                  <ul> {{each data as value i}} <li><span><i><img src={{value.img}} alt=\"\"> </i><b>{{value.title}}</b></span></li>{{/each}}</ul>                </script>           </section>          </div>          <div class=\"swiper-slide\">slider2</div>          <div class=\"swiper-slide\">slider3</div>        </div>      </div>    </section></div>"

/***/ },
/* 5 */
/***/ function(module, exports) {

	module.exports = "<footer>    <ul id=\"footer\">        <li class=\"active\" data-url=\"/build/prd/index.html\">            <i class=\"iconfont\">&#xe6bb;</i>            <b>首页</b>        </li>        <li data-url=\"/build/prd/index.html\">            <i class=\"iconfont\">&#xe65c;</i>            <b>发现</b>        </li>        <li>            <i class=\"iconfont\">&#xe664;</i>        </li>        <li>            <i class=\"iconfont\">&#xe735;</i>            <b>我的</b>        </li>        <li>            <i class=\"iconfont\">&#xe603;</i>            <b>退出</b>        </li>    </ul></footer>"
